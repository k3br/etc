...
Public Function FormatPhoneNumber(ByVal numberPrefix As String, ByVal phoneNumber As String) As String
    ...
    If Not HasCountryCallerPrefix(phoneNumber) Then
         ...
         'Odstranimo vodilno niclo od stevilke in dodamo num prefix
...
Public Function Fikuphone(ByVal numberPrefix As String, ParamArray Cells() As Variant) As String
        ...
        If VarType(cell) > vbArray Then
            For Each SubCell In cell
                If VarType(SubCell) <> vbEmpty Then
                    Fikuphone = FormatPhoneNumber(numberPrefix, SubCell)
                    Exit Function
                End If
            Next
        Else
            If VarType(cell) <> vbEmpty Then
                Fikuphone = FormatPhoneNumber(numberPrefix, cell)
                Exit Function
            End If
        End If
    Next
